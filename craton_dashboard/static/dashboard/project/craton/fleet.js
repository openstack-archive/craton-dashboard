...
(function() {
   ...
   */
  angular
    .module('horizon.dashboard.project.craton', [])
    .config(config);
  ...
  function config($provide, $windowProvider, $routeProvider) {
    var basePath = $windowProvider.$get().STATIC_URL + 'dashboard/project/craton/';
    $provide.constant('horizon.dashboard.project.craton.basePath', basePath);
